...
void software_request_generator::gemm_translation()
{
	...
	selected_filter_tile_width = MIN(MAX(1, MIN(tile_filter_size/element_unit/selected_tile_width, tile_ofmap_size/element_unit/selected_tile_height)), filter_width);
	if(SUM_TILING)
		selected_filter_tile_width = MIN(MAX(1, (sum_tile_size/2-selected_tile_height*selected_tile_width)/(selected_tile_height+selected_tile_width)), filter_width);

	if(selected_filter_tile_width == filter_width)
	{
		selected_tile_width = MIN(MAX(1, MIN(tile_filter_size/element_unit/selected_filter_tile_width, tile_ifmap_size/element_unit/selected_tile_height)), ifmap_width);
		if(SUM_TILING)
			selected_tile_width = MIN(MAX(1, (sum_tile_size/2-selected_tile_height*selected_filter_tile_width)/(selected_tile_height+selected_filter_tile_width)), ifmap_width);
	}
